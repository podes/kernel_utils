 ...
 */
extern void dlm_avl_create(avl_tree_t *tree,
 ...
 */
extern void *dlm_avl_find(avl_tree_t *tree, const void *node, avl_index_t *where);
 ...
 */
extern void dlm_avl_insert(avl_tree_t *tree, void *node, avl_index_t where);
 ...
 */
extern void dlm_avl_insert_here(avl_tree_t *tree, void *new_data, void *here,
			    int direction);
 ...
 *
 */
extern void *dlm_avl_first(avl_tree_t *tree);
extern void *dlm_avl_last(avl_tree_t *tree);
 ...
 */
#define	AVL_NEXT(tree, node)	dlm_avl_walk(tree, node, AVL_AFTER)
#define	AVL_PREV(tree, node)	dlm_avl_walk(tree, node, AVL_BEFORE)
 ...
 */
extern void *dlm_avl_nearest(avl_tree_t *tree, avl_index_t where, int direction);
 ...
 */
extern void dlm_avl_add(avl_tree_t *tree, void *node);
 ...
 */
extern void dlm_avl_remove(avl_tree_t *tree, void *node);
 ...
 * node may change.
 */
extern boolean_t dlm_avl_update(avl_tree_t *, void *);
extern boolean_t dlm_avl_update_lt(avl_tree_t *, void *);
extern boolean_t dlm_avl_update_gt(avl_tree_t *, void *);

/*
 * Return the number of nodes in the tree
 */
extern ulong_t dlm_avl_numnodes(avl_tree_t *tree);

/*
 * Return B_TRUE if there are zero nodes in the tree, B_FALSE otherwise.
 */
extern boolean_t dlm_avl_is_empty(avl_tree_t *tree);
 ...
 *	avl_destroy(tree);
 */
extern void *dlm_avl_destroy_nodes(avl_tree_t *tree, void **cookie);
 ...
 */
extern void dlm_avl_destroy(avl_tree_t *tree);
